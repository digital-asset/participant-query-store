...
import com.digitalasset.pqs.configuration.{EnvVarPrefix, OptionConfigFromFile}
...
package object app:
  ...
  def cliConfig[T: Tag: Descriptor]: CliTree[ZLayer[Any, Throwable, T]] = CliTree.Remaining(
    args => ZLayer.succeed(ZIOAppArgs(Chunk.fromIterable(args))) >>> com.digitalasset.pqs.configuration.apply[T],
    verbose => {
      import com.digitalasset.pqs.configuration.PrettyPrinter.ConfigDescriptor.*
