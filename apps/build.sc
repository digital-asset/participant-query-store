    ...
    object docker extends BuildxDockerConfig {
      ...
      def run = T {
        super.run() ++ Seq(
          ...
          s"wget https://repo1.maven.org/maven2/io/opentelemetry/javaagent/opentelemetry-javaagent/${V.openTelemetryAgent}/opentelemetry-javaagent-${V.openTelemetryAgent}.jar -O /agent/otel.jar"
        )
      }
    }
