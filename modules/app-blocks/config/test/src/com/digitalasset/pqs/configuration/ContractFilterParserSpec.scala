...
import com.digitalasset.pqs.configuration.filter.{ContractFilterParser, DottedName, QualifiedName}
import com.digitalasset.pqs.configuration.filter.ContractFilterParser.*
