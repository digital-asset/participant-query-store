...
import com.digitalasset.scribe.docker.Client.{run, streamMap}
import com.digitalasset.scribe.docker.tls.CertificateAuthority
  ...
  private case class Impl(
    ...
    private def mkContainer(
      ...
      containerId <- acquireRelease( // acquire
        ...
        // Try to stop the container gracefully. This allows Scribe to close its database connections properly.
        client
