...
package object docker:
  ...
  /** Identifies a single functional-test Docker session.
    ...
    *
    * @param prefix
    *   Resource name prefix, e.g. `"pqs-ft-3a7f2b1c0d9e8"`. Used for naming and safety-net cleanup.
    ...
    *   user-supplied network name (`pqs-ft-network-<seed>`) -- Docker returns its own internal ID when the network is
    *   created.
    * @param volumeName
    *   The Docker volume name, e.g. `"pqs-ft-volume-3a7f2b1c0d9e8"`. Equals the user-supplied name because
