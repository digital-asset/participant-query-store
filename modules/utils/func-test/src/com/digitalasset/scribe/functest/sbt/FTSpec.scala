...
import com.digitalasset.scribe.docker.{Docker, DockerResources}
import com.digitalasset.scribe.functest.{Dpm, FTEnv, FTLogging, FuncTest}
...
object FTSpec extends ZIOSpecDefault:
  ...
  private val LaneCostGb = 0.8 // Per-lane: Scribe/DamlSdk containers + GC/fragmentation overhead
