...
import com.digitalasset.pqs.health.HealthEndpoint.responseStatus
...
object PackageReloadSpec extends SharedLedgerAndPostgresTest:
  ...
  def spec = suite("Package reload")(
    // Earlier, deploying a new package while the pipeline was running caused Pqs
    ...
    // Pqs would silently miss new packages entirely — no error, no reload, just lost updates.
