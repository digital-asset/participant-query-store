...
object Database:
  ...
  // Internal table with no public SQL function yet, hence the raw select. Joins __contract_tpe to report
  // template_fqn rather than a pk, which is assigned by insertion order and would make assertions brittle.
